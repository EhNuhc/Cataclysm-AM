...
minimap_submap_cache::minimap_submap_cache( minimap_shared_texture_pool &pool ) : ready( false ),
    pool( pool )
{
...
void cata_tiles::do_tile_loading_report()
{
    ...
    if( !DynamicDataLoader::get_instance().is_data_finalized() ) {
