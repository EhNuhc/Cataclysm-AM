...
class game_member_deps
{
    public:
        game_member_deps( map &p_m, player &p_u ) :
            m( p_m ),
            u( p_u )
        {}
...
#ifdef THERE_IS_NO_GAME
extern game_member_deps *g;
#else
extern game *g;
#endif
...
class game
{
    ...
    public:
        ...
        std::unique_ptr<faction_manager> faction_manager_ptr;
    ...
    private:
        ...
        int next_mission_id; // Keep track of UIDs
