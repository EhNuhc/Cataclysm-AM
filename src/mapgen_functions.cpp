...
void mapgen_gas_station( map *m, oter_id terrain_type, mapgendata dat, const time_point &turn,
                         float density )
{
    int top_w = rng( 5, 14 );
    ...
    m->place_items( "softdrugs", 12, right_w - 1, bottom_w - 2, right_w - 1, bottom_w - 2, false,
                    turn );
